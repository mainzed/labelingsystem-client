...
angular.module('labelsApp')
  .directive('lsVocabResultBox', function (ngDialog, LabelService, ResourcesService) {
    return {
        templateUrl: "scripts/components/enrichment-browser/vocab-result-box/vocab-result-box.html",
        restrict: 'E',
        // scope: {
        //     data: "="
        // },
        link: function postLink(scope) {
            ...
            scope.openDialog = function() {
                ngDialog.open({
                    template: 'scripts/components/enrichment-browser/vocab-result-box/dialog.html',
                    className: 'bigdialog',
                    showClose: false,
