...
angular.module('labelsApp')
  .directive('lsSearchResultBox', function (ngDialog, LabelService, ResourcesService) {
    return {
        templateUrl: "scripts/components/label-details/enrichment-browser/search-result-box/search-result-box.html",
        restrict: 'E',
        // scope: {
        //     data: "=",
        ...
        link: function postLink(scope, element, attrs) {
            ...
            scope.onClick = function() {
                ngDialog.open({
                    template: 'scripts/components/label-details/enrichment-browser/search-result-box/dialog.html',
                    className: 'bigdialog',
                    showClose: false,
